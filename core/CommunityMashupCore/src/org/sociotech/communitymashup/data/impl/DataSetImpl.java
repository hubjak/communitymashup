	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			...
			case DataPackage.DATA_SET___GET_WEB_SITES:
				return getWebSites();
			case DataPackage.DATA_SET___GET_CITATIONS:
				return getCitations();
...
//				}
	 ...
	 *
	 * @return All Citations of this DataSet.
	 * @generated
	 */
	public EList<Citation> getCitations() {
		...
		IQueryResult result = DataPackageImpl.filterItemsMatchingCondition(getItems(), oclCondition.AND(Citation.isTypeCondition));
	...
	/**
	 * Returns all Citations matching the provided condition.
	 *
	 * @condition The condition to filter the Citations.
	 * @return All Citations of this DataSet matching the condition.
	 * @generated
	 */
	public EList<Citation> getCitationsMatchingCondition(EObjectCondition condition) {
		if (condition == null) return null;
		IQueryResult result = getItemsMatchingCondition(Citation.isTypeCondition.AND(condition));
		EList<Citation> resList = new BasicEList<Citation>();
		if (result != null) {
			for (EObject eo: result.getEObjects()) {
				resList.add((Citation) eo);
			}
		}
		return resList;
	}
