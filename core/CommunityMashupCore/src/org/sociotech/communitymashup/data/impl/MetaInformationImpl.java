...
public class MetaInformationImpl extends ExtensionImpl implements MetaInformation {
	...
	public static EObjectCondition generateIsTypeCondition() {
		...
		return result.OR(Phone.isTypeCondition).OR(InstantMessenger.isTypeCondition).OR(Email.isTypeCondition).OR(WebAccount.isTypeCondition).OR(WebSite.isTypeCondition).OR(Location.isTypeCondition).OR(IndoorLocation.isTypeCondition).OR(Event.isTypeCondition).OR(Citation.isTypeCondition);
	}
	/**
